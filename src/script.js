var quotes = [{
  ...
  author: 'Ja\'mie King (Ja\'mie: Private School Girl)',
  link: 'foo'
}, {
  quote: 'I\m just in it for the sugar',
  author: 'Max Braverman (Parenthood)',
  link: 'foo'
}, {
  quote: 'Now that we\'re finally free, I get why we fought so hard. The real gift isn\'t freedom, it\'s what we get to do with it.',
  author: 'Nikita Mears (Nikita)',
  link: 'foo'
}, {
  quote: 'I\'m the doctor. But probably not the one you were expecting',
  author: 'The Eighth Doctor (Doctor Who)',
  link: 'foo'
}, {
  quote: 'Chaos isn\'t a pit. Chaos is a ladder',
  author: 'Littlefinger (Game of Thrones)',
  link: 'foo'
}, {
  quote: 'Thanks God I am a conspiracy theorist and not a doomsday hysteric.',
  ...
  quote: 'God, you\'re awful. And you don\'t know how awful you\'re.',
  author: 'Will Gardner (The Good Wife)',
  link: 'foo'
}, {
  quote: 'I refuse to be a failure. I don\'t care what you want anymore. This is how it\'s going to work : You will be here only when I tell you to be here. I\'m drawing a 50 mile radius around this house and if you so much as open your fly to urinate, I will destoy you.',
  author: 'Trudy Campbell (Mad Men)',
  link: 'foo'
}, {
  ...
  author: 'Mike Ehrmantraut (Breaking Bad)',
  link: 'foo'
}, {
  quote: 'It’s a shame you can only die once.',
  ...
  quote: 'I’ll kill a man in a fair fight... or if I think he’s gonna start a fair fight.',
  author: 'Jayne Cobb (Firefly)',
  link: 'foo'
}, {
  quote: 'Here’s my counter-offer to your counter-offer: Go f*ck yourself.',
  ...
  quote: 'Hello, boys. Tell us what you’re doing here and we’ll tell you why it’s a crime.',
  author: 'Vic Mackey (The shield)',
  link: 'foo'
}, {
  quote: 'Some roads you shouldn’t go down. Because maps used to say ‘There be dragons here.’ Now they don’t. But that don’t mean the dragons aren’t there.',
  author: 'Lorne Malvo (Fargo)',
  link: 'foo'
}, {
  ...
  quote: 'What good is money if you can’t use it to strike fear into the hearts of your fellow men?',
  author: 'Montgomery Burns (The simpsons)',
  link: 'foo'
}, {
  ...
  quote: 'I saved you a bullet.',
  author: 'Kate Austen (Lost)',
  link: 'foo'
}, {
  quote: 'I’m not going to die in a hospital where the nurses aren’t even hot.',
  author: 'Dean Winchester (Supernatural)',
  link: 'foo'
}, {
  quote: 'There are no men like me. Only me.',
  author: 'Jaime Lannister (Game of thrones)',
  link: 'foo'
}, {
  quote: 'You don\'t know what it\'s like out there. You may think you do, but you don\'t.',
  ...
  quote: 'Do you really want to say no to me?',
  author: 'Joanna (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Is there a pocket in the world you don\'t have a hand in?',
  author: 'Terry Colbe (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Politics is for puppets',
  author: 'Philip Price (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'You see, I\'m a mercenary. I don\'t play fair. I play what I want. You deal with a mercenary, then all decorum gets tossed out the window. So you go ahead with your cute threats and your watch beeps. Order will not protect you anymore, my friend. I will rain chaos, even if it hurts me. Because I would rather see you lose than win myself. Oh. That\'s all the time I have.',
  author: 'Philip Price (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'You\'re a plumber, right, Steve? You\'ve had, what, 60 years at life? And that\'s the best you can come up with. Literally cleaning shit for a living. I\'m 27, and I\'ve got a six figure salary at the biggest conglomerate in history. And I\'m just getting started.',
  author: 'Angela (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Every relationship is a power struggle.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Killing a man instantly robs him of explanation. He has no time to process his final moments. Now, even though he was paralyzed, his mind was still able to understand why his life was ending. We let him die with answers. Otherwise, we\'re nothing but ruthless murderers.',
  author: 'Joanna (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'You\'ve surrounded yourself with a constant reminder of mortality.',
  author: 'Dom (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Control is about as real as a unicorn taking a leak at the end of a double rainbow.',
  author: 'Ray (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'I will not be owned.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'I have value, and even though you don\'t see it, they do.',
  author: 'Angela (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'We are in a war, and we are on the losing side of it. We are on our knees with guns to our heads, and they are picking us off one by one.',
  author: 'Darlene (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'How do I take off a mask when it stops being a mask? When it\'s as much a part of me as me?',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  ...
  quote: 'Face it: you have been owned.',
  author: 'Mr. Robot',
  link: 'foo',
}, {
  quote: 'I thought I\'d feel guilty for being a murderer but... I don\'t. I feel wonder.',
  author: 'Tyrell (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Everyone is destroying the planet beyond the point of no return. Are you really going to start taking all of these things so personally?',
  author: 'Terry Colby (Mr. robot)',
  link: 'foo',
}, {
  quote: 'If you want to change things, perhaps you should try from within.',
  author: 'Terry Colby (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Corporate greed is a trickle down desire that reaches even the bottom of the food chain.',
  author: 'Darlene (Mr. Robot)',
  link: 'foo',
}, {
  ...
  quote: 'If they lock me up the kind of door they close doesn\'t matter.',
  author: 'Fernando Vera (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'There\'s a saying - \'The devil is at his strongest while we\'re looking the other way.\' Like a program running in the background silently. While we\'re busy doing other shit.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'People walk around acting like they know what hate means. Nah. No one does until you hate yourself... I mean, truly hate yourself. That\'s power.',
  author: 'Fernando (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Give a man a gun and he can rob a bank. Give a man a bank and he can rob the world.',
  author: 'Tyrell (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'I do morphine. The key to doing morphine without turning into a junkie is to limit yourself to 30 milligrams a day. Anything more just builds up your tolerance.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Everyone steals. That\'s how it works. You think people out there are getting exactly what they deserve? No. They\'re getting paid over or under, but someone in the chain always gets bamboozled. I steal, son, but I don\'t get caught. That\'s my contract with society. Now if you can catch me stealing, I\'ll go to jail. But if you can\'t, then I\'ve earned the money.',
  author: 'Fernando (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'Hello, friend. Hello, friend? That\'s lame. Maybe I should give you a name, but that\'s a slippery slope. You\'re only in my head. We have to remember that. Shit.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  quote: 'What is it about society that disappoints you so much? ... Oh, I don\'t know. Is it that we collectively thought Steve Jobs was a great man, even when we knew he made billions off the backs of children? Or maybe it\'s that it feels like all our heroes are counterfeit. The world itself\'s just one big hoax.',
  author: 'Krista + Elliot (mr. Robot)',
  link: 'foo',
}, {
  quote: 'You\'re only seeing what\'s in front of you, you\'re not seeing what\'s above you.',
  author: 'Elliot (Mr. Robot)',
  link: 'foo',
}, {
  ...
  quote: 'What\'s the point of being an outlaw when you got responsibilities?',
  author: 'Jesse (Breaking bad)',
  link: 'foo',
}, {
  ...
  author: 'Saul (Breaking bad)',
  link: 'foo',
}, {
  quote: 'If you died, would anyone care? Would they really care? Maybe, they\'d cry for a day. But, let\'s be honest, no one would give a shit. They wouldn\'t. The few people that would feel obligated to go to your funeral would probably be annoyed and leave as early as possible. That\'s who you are. That\'s what you are. You\'re nothing to anyone. To everyone.',
  author: 'Mr. Robot',
  link: 'foo',
}, {
  quote: 'Is any of it real? I mean, look at this. Look at it! A world built on fantasy. Synthetic emotions in the form of pills. Psychological warfare in form of advertising. Mind altering chemicals in form of ... food! Brainwashing seminars in the form of media. Controlled isolated bubbles in the form of social networks. Real? You want to talk about reality? We haven\'t lived in anything remotely close to it since the turn ogf the century',
  author: 'Mr Robot',
  link: 'foo',
}, {
  quote: 'Sometimes I dream of saving the world; saving everyone from the invisible hand; one that brands us with an employee badge; the one that forces us to work for them; the one that controls us every day without us knowing it.',
  author: 'Mr. Robot',
  link: 'foo',
}, {
  quote: 'There\'s not just the rich and the poor. There\'s you, in the middle somewhere. The consummate survivor',
  author: 'Mr. Robot',
  link: 'foo',
}, {
  quote: 'People fake a lot of human interactions, but I feel like I fake them all, and I fake them very well, that’s my burden, I guess.',
  author: 'Dexter',
  link: 'foo',
}, {
  ...
  quote: 'Do I see sheets of plastic in your future?',
  author: 'Dexter',
  link: 'foo',
}, {
...
function randomQuotes() {
  ...
  if (arrRandomNum.length != maxNum) {
    ...
    if (quotes[randomNum].link == 'foo') {
      resultQuote = element.innerHTML = '<p>' + quotes[randomNum].quote + '</p>' + '<footer><a href="foo" class="link brackets author">' + quotes[randomNum].author + '</a><span class="cursor blink">&foo9646;</span></footer>';
      console.log('author, no link');
    } else {
      resultQuote = element.innerHTML = '<p>' + quotes[randomNum].quote + '</p>' + '<footer><a href="' + quotes[randomNum].link + '" target="_blank" class="link brackets author">' + quotes[randomNum].author + '</a><span class="cursor blink">&foo9646;</span></footer>';
    }

    tweetButton(randomNum);

  } else {
    resultQuote = element.innerHTML = '<div class="warning"><span>WARNING</span><p> you have reached the quotes <span class="cursor blink">&foo9646;</span></p></div>';
...
memAddClass(randomNum);
  ...
  function type(){
    ...
    if (text === resultQuote) return;
      ...
      element.innerHTML = text+'&foo9646;';
